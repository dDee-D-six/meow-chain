...
echo $ORACLE1_MNEMONIC | meowd keys add oracle1 --recover --home ${SIX_HOME} --algo eth_secp256k1 --keyring-backend test
echo $ORACLE2_MNEMONIC | meowd keys add oracle2 --recover --home ${SIX_HOME} --algo eth_secp256k1 --keyring-backend test
echo $ORACLE3_MNEMONIC | meowd keys add oracle3 --recover --home ${SIX_HOME} --algo eth_secp256k1 --keyring-backend test
echo $ORACLE4_MNEMONIC | meowd keys add oracle4 --recover --home ${SIX_HOME} --algo eth_secp256k1 --keyring-backend test
...
meowd add-genesis-account $(meowd keys show -a oracle1 --keyring-backend=test --home ${SIX_HOME}) 1000000000000ameow --keyring-backend test --home ${SIX_HOME}
meowd add-genesis-account $(meowd keys show -a oracle2 --keyring-backend=test --home ${SIX_HOME}) 1000000000000ameow --keyring-backend test --home ${SIX_HOME}
meowd add-genesis-account $(meowd keys show -a oracle3 --keyring-backend=test --home ${SIX_HOME}) 1000000000000ameow --keyring-backend test --home ${SIX_HOME}
meowd add-genesis-account $(meowd keys show -a oracle4 --keyring-backend=test --home ${SIX_HOME}) 1000000000000ameow --keyring-backend test --home ${SIX_HOME}
...
meowd start --home ${SIX_HOME} --trace